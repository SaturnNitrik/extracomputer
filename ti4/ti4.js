...
["The Shipwrights of Axis", "Les Chantiers d'Axis", "Die Schiffbauer von Axis", "Кораблестроители Аксиса", "Los Constructores Navales de Axis", "阿克西斯造舰师", "Stoczniowcy z Axis", IMG_FOLDER + "axis.png", "", "Axis"],
["The Bentor Conglomerate", "Le Conglomérat Bentor", "Das Bentor-Konglomerat", "Конгломерат Бентор", "El Conglomerado Bentor", "本托尔联合财团", "Konglomerat Bentor", IMG_FOLDER + "bentor.png", "", "Bentor"],
["The Celdauri Trade Confederation", "La Confédération commerciale celdauri", "Die Celdauri-Handelskonföderation", "Торговая конфедерация Селдаури", "La Confederación Comercial Celdauri", "塞尔道里贸易邦联", "Konfederacja Handlowa Celdauri", IMG_FOLDER + "celdauri.png", "", "Celdauri"],
["The Cheiran Hordes", "Les Hordes cheiran", "Die Horden der Cheiran", "Орды Шейран", "Las Hordas Cheiran", "凯兰部落大军", "Hordy Cheiran", IMG_FOLDER + "cheiran.png", "", "Cheiran"],
["The Savages of Cymiae", "Les Sauvages de Cymiae", "Die Wilden von Cymiae", "Дикари Симайи", "Los Salvajes de Cymiae", "西迈埃野民", "Dzikusy z Cymiae", IMG_FOLDER + "cymiae.png", "", "Cymiae"],
["The Dih-Mohn Flotilla", "La Flottille Dih-Mohn", "Die Dih-Mohn-Flottille", "Флотилия Дих-Мон", "La Flotilla Dih-Mohn", "迪赫-莫恩舰队", "Flotylla Dih-Mohn", IMG_FOLDER + "dih-mohn.png", "", "Dih-Mohn"],
["The Edyn Mandate", "Le Mandat d'Edyn", "Das Edyn-Mandat", "Мандат Эдин", "El Mandato de Edyn", "伊登训令领", "Mandat Edyn", IMG_FOLDER + "edyn.png", "", "Edyn"],
["The Florzen Profiteers", "Les Profiteurs florzen", "Die Florzen-Profiteure", "Флорзенские спекулянты", "Los Traficantes Florzen", "弗洛尔岑投机客", "Spekulanci Florzen", IMG_FOLDER + "florzen.png", "", "Florzen"],
["The Free Systems Compact", "Le Pacte des Systèmes Libres", "Der Bund Freier Systeme", "Союз Свободных Систем", "El Pacto de los Sistemas Libres", "自由星系联合体", "Pakt Wolnych Systemów", IMG_FOLDER + "fsc.png", "", "Free Systems"],
["The Ghemina Raiders", "Les Pillards de Ghemina", "Die Plünderer von Ghemina", "Налётчики Гемины", "Los Saqueadores de Ghemina", "格米纳掠袭者", "Rabusie Gheminy", IMG_FOLDER + "ghemina.png", "", "Ghemina"],
["The Ghoti Wayfarers", "Les Voyageurs ghoti", "Die Ghoti-Wandersleute", "Странники Готи", "Los Errantes Ghoti", "戈提远行者", "Wędrowcy Ghoti", IMG_FOLDER + "ghoti.png", "", "Ghoti"],
["The GLEdge Union", "L'Union GLEdge", "Die GLEdge-Union", "Союз GLEdge", "La Unión GLEdge", "GLEdge联盟", "Unia GLEdge", IMG_FOLDER + "gledge.png", "", "GLEdge"],
["The Augurs of Ilyxum", "Les Augures d'Ilyxum", "Die Auguren von Ilyxum", "Авгуры Иликсум", "Los Augures de Ilyxum", "伊利克瑟姆占卜师", "Augurzy Ilyxum", IMG_FOLDER + "ilyxum.png", "", "Ilyxum"],
["The Berserkers of Kjalengard", "Les Berserkers de Kjalengard", "Die Berserker von Kjalengard", "Берсерки Кьяленгарда", "Los Bersérkeres de Kjalengard", "夏伦加德狂战士", "Berserkerzy z Kjalengardu", IMG_FOLDER + "Berserkers.png", "", "Kjalengard"],
["The Kollecc Society", "La Société Kollecc", "Die Kollecc-Gesellschaft", "Общество Коллекк", "La Sociedad Kollecc", "科莱克社团", "Społeczeństwo Kollecc", IMG_FOLDER + "collecc.png", "", "Kollecc"],
["The Monks of Kolume", "Les Moines de Kolume", "Die Mönche von Kolume", "Монахи Колуме", "Los Monjes de Kolume", "科卢姆僧团", "Mnisi z Kolume", IMG_FOLDER + "kolume.png", "", "Kolume"],
["The Kortali Tribunal", "Le Tribunal kortali", "Das Kortali-Tribunal", "Трибунал Кортали", "El Tribunal Kortali", "科塔利审判庭", "Trybunał Kortali", IMG_FOLDER + "kortali.png", "", "Kortali"],
["The Kyro Sodality", "La Sodalité de Kyro", "Die Kyro-Bruderschaft", "Содружество Кайро", "La Sodalidad de Kyro", "凯罗同道会", "Bractwo Kyro", IMG_FOLDER + "kyro.png", "", "Kyro"],
["The Lanefir Remnants", "Les Vestiges de Lanefir", "Die Überreste von Lanefir", "Остатки Ланефира", "Los Remanentes de Lanefir", "拉内菲尔遗众", "Niedobitki Lanefir", IMG_FOLDER + "lanefir.png", "", "Lanefir"],
["The Li-Zho Dynasty", "La Dynastie Li-Zho", "Die Li-Zho-Dynastie", "Династия Ли-Чжо", "La Dinastía Li-Zho", "李卓王朝", "Dynastia Li-Zho", IMG_FOLDER + "li-zho.png", "", "Li-Zho"],
["The L'tokk Khrask", "Les L'tokk Khrask", "Die L'tokk Khrask", "Л'токк Краск", "Los L'tokk Khrask", "勒托克克拉斯克", "L'tokk Khrask", IMG_FOLDER + "ltokk.png", "", "L tokk"],
["The Mirveda Protectorate", "Le Protectorat de Mirveda", "Das Mirveda-Protektorat", "Протекторат Мирведа", "El Protectorado de Mirveda", "米尔维达保护国", "Protektorat Mirvedy", IMG_FOLDER + "mirveda.png", "", "Mirveda"],
["The Glimmer of Mortheus", "L'Éclat de Mortheus", "Der Schimmer von Mortheus", "Проблеск Мортеуса", "El Resplandor de Mortheus", "莫耳修斯微光", "Blask Mortheusa", IMG_FOLDER + "glimmer.png", "", "Mortheus"],
["The Myko-Mentori", "Les Myko-Mentori", "Die Myko-Mentori", "Майко-Ментори", "Los Myko-Mentori", "麦科-门托里", "Myko-Mentori", IMG_FOLDER + "myko.png", "", "Myko"],
["The Nivyn Star Kings", "Les Rois Stellaires Nivyn", "Die Nivyn-Sternkönige", "Звёздные короли Нивин", "Los Reyes Estelares Nivyn", "尼文星王", "Gwiezdni Królowie Nivyn", IMG_FOLDER + "nivyn.png", "", "Nivyn"],
["The Nokar Sellships", "Les Vaisseaux-Marchands Nokar", "Die Handelsschiffe der Nokar", "Нокарские корабли-торговцы", "Las Naves Mercantes Nokar", "诺卡商售舰队", "Statki Handlowe Nokar", IMG_FOLDER + "nokar.png", "", "Nokar"],
["The Olradin League", "La Ligue Olradin", "Die Olradin-Liga", "Лига Олрадин", "La Liga Olradin", "奥拉丁同盟", "Liga Olradin", IMG_FOLDER + "olradin.png", "", "Olradin"],
["The Zealots of Rhodun", "Les Zélotes de Rhodun", "Die Zeloten von Rhodun", "Фанатики Родун", "Los Zelotes de Rhodun", "罗顿狂信者", "Zeloci Rhodun", IMG_FOLDER + "rhodun.png", "", "Rhodun"],
["Roh'Dhna Mechatronics", "Mécatronique Roh'Dhna", "Roh'Dhna-Mechatronik", "Мехатроника Рох-Дна", "Mecatrónica Roh'Dhna", "罗德纳机电体", "Mechatronika Roh'Dhna", IMG_FOLDER + "rohdna.png", "", "Roh Dhna"],
["The Tnelis Syndicate", "Le Syndicat Tnelis", "Das Tnelis-Syndikat", "Синдикат Тнелис", "El Sindicato Tnelis", "特内利斯辛迪加", "Syndykat Tnelis", IMG_FOLDER + "tnelis.png", "", "Tnelis"],
["The Vaden Banking Clans", "Les Clans bancaires de Vaden", "Die Bankclans von Vaden", "Банковские кланы Ваден", "Los Clanes Bancarios de Vaden", "瓦登银行氏族", "Klany Bankierskie Vaden", IMG_FOLDER + "vaden.png", "", "Vaden"],
["The Vaylerian Scourge", "Le Fléau vaylérien", "Die vaylerianische Geißel", "Вайлерийская Чума", "El Azote Vayleriano", "维勒里安灾祸", "Plaga Vaylerian", IMG_FOLDER + "vaylerian.png", "", "Vaylerian"],
["The Veldyr Sovereignty", "La Souveraineté Veldyr", "Die Veldyr-Souveränität", "Суверенитет Вельдир", "La Soberanía Veldyr", "维尔迪尔主权国", "Suwerenność Veldyr", IMG_FOLDER + "veldyr.png", "", "Veldyr"],
["The Zelian Purifier", "Le Purificateur zélien", "Der Zelian-Läuterer", "Зелианский очиститель", "El Purificador Zeliano", "泽利安净化者", "Zeliański Czyściciel", IMG_FOLDER + "zelian.png", "", "Zelian"],
["The Drahn Consortium", "Le Consortium Drahn", "Das Drahn-Konsortium", "Консорциум Дран", "El Consorcio Drahn", "德拉恩财团", "Konsorcjum Drahn", IMG_FOLDER + "drahn.png", "", "Drahn"]
];

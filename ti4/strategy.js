...
function pageInit()
{
    ...
    /* Load General part by default */
    fctTarget('clGuideGeneral');
...
{
    // reset all
    fctDisplayAll("clTopic", "none");
    
    // Show target
    fctDisplayAll(str, "");
    
    // Unhighlight previous button
    document.getElementsByClassName("clButtonOn")[0].classList.remove("clButtonOn");
    
    // Highlight button
    document.getElementsByClassName(str)[0].classList.add("clButtonOn");
}
